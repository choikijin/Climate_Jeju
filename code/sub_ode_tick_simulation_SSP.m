function [f]=sub_ode_tick_simulation_SSP(parameter, xdata)

global dt init_C mu1 mu2 mu3 mu4 mu5 rho K a init_C_inci
...
f{1} = [round(Final_inci_Lar)' round(Final_inci_Lym)' round(Final_inci_Adu)'];
f{2} = {Total', X1', X2', X3', X4', X5'};
f{3} = Final_inci_Total';
f{4} = {round(Final_inci_Lar)', round(Final_inci_Lym)', round(Final_inci_Adu)'};
f{5} = [d1' d2' d3' d4'];
f{6} = Final_inci_Total';
end